...
class User < ActiveRecord::Base
        ...
        html_content = '<!DOCTYPE html>
                            ...
                            <body style="margin: 0 auto;
                              ...
                              <div style="margin: 20px 0 0 0;text-align:left; float:left;">
                                <img src="http://mister-pompadour-test-referral.herokuapp.com/assets/refer/email_logo.jpg">
                              </div>
                              ...
                              <div style="margin-top: 20px;">
                                <img src="http://mister-pompadour-test-referral.herokuapp.com/assets/refer/email_0.png">
                              </div>'
    ...
    def email_footer_content footer_type, text_message
        ...
        root_url = "http://mister-pompadour-test-referral.herokuapp.com/"
        ...
        footer_content += '" target="_blank" style="background: url(http://mister-pompadour-test-referral.herokuapp.com/assets/refer/fb.png); background-size: 27px 27px; width:27px; height: 27px; display: inline-block;"></a>
        ...
        footer_content += '" target="_blank" style="background: url(http://mister-pompadour-test-referral.herokuapp.com/assets/refer/twit.png); background-size: 27px 27px; width:27px; height: 27px; display: inline-block;"></a>
                            </div>  
                          </div>
                          '
    ...
    def referral_friends_header header_type
        ...
        html_content += '</div>
                              <div style="margin-top: 20px;">
                                <img src="http://mister-pompadour-test-referral.herokuapp.com/assets/refer/'
